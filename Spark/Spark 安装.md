...
# 3. 安装hadoop
下载网址：https://archive.apache.org/dist/hadoop/common/（下载特慢，但是版本全）
https://mirrors.tuna.tsinghua.edu.cn/apache/hadoop/common/（**清华镜像，下载快，但是版本不全，我选择的是在这里下载的是hadoop-2.7.7**）
